...
```groovy
  ...
  dependencies {
      implementation 'io.github.intisy:simple-java-gui:1.3.4'
  }
```
...
```groovy
  plugins {
      id "io.github.intisy.simple-java-gui" version "1.3.4"
  }
  dependencies {
      githubImplementation "intisy:simple-java-gui:1.3.4"
  }
```
